...
public class DeviceUuidUtils {
    ...
    private static DeviceUuidUtils deviceUuidFactory;

    public static DeviceUuidUtils getInstance(Context context) {
        if (deviceUuidFactory == null) {
            deviceUuidFactory = new DeviceUuidUtils(context);
        }
        return deviceUuidFactory;
    }

    private DeviceUuidUtils(Context context) {
        if (uuid == null) {
